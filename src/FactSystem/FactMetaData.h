...
public:
    ...
    bool            qmlRebootRequired       (void) const { return _qmlRebootRequired; }
    ...
    void setqmlRebootRequired       (bool rebootRequired)               { _qmlRebootRequired = rebootRequired; }
...
private:
    ...
    static const char* _qmlRebootRequiredJsonKey;
