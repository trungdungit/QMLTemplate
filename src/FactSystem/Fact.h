...
public:
    ...
    /// Creates a Fact using the name and type from metaData. Also calls QMLCorePlugin::adjustSettingsMetaData allowing
    ...
    Q_PROPERTY(bool         qmlRebootRequired       READ qmlRebootRequired                                  CONSTANT)
    ...
    bool            qmlRebootRequired       (void) const;
    ...
    Q_INVOKABLE void _setIgnoreQMLRebootRequired(bool ignore);
