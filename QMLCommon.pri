...
exists ($$PWD/.git) {
    ...
    message(QMLTemplate APP_VERSION_STR VERSION $${APP_VERSION_STR} $${VERSION})

    MacBuild {
        MAC_VERSION  = $$section(VERSION, ".", 0, 2)
        MAC_BUILD    = $$section(VERSION, ".", 3, 3)
        message(QMLTemplate MAC_VERSION MAC_BUILD $${MAC_VERSION} $${MAC_BUILD})
    }
}
DEFINES += APP_VERSION_STR=\"\\\"$$APP_VERSION_STR\\\"\"

AndroidBuild {
    QML_ANDROID_PACKAGE = org.mavlink.qmltemplate
